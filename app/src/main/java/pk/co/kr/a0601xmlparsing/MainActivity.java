...
public class MainActivity extends AppCompatActivity {
    ...
    //객체는 1개만 생성됩니다.
    //handleMessage가 콜백 메소드(이벤트가 발생하면 자동으로 호출되는 메소드)
    //이므로 객체를 1개만 만들면 됩니다.
    ...
    //메소드 이므로 여러 번 사용할려면 객체를 여러 개 만들어 야 하는 경우가
    //있습니다.
    //스레드는 한 번 만들고 종료되면 재사용이 안되는 객체입니다.
    //매번 새로 만들어서 사용해야 하기 때문에 별도로 클래스를 만들어서
    //사용하거나 이벤트가 발생할 때 마다 익명 객체를 만들어서
    //사용해야 합니다.
